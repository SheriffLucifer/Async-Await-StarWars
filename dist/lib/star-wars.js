...
const starWars = {
    ...
    // --- Get By Id Methods ---
    getCharactersById: async (id) => await (await fetch(`https://swapi.dev/api/people/${id}`)).json(),
    getPlanetsById: async (id) => await (await fetch(`https://swapi.dev/api/planets/${id}`)).json(),
    getSpeciesById: async (id) => await (await fetch(`https://swapi.dev/api/species/${id}`)).json(),
    getFilmsById: async (id) => await (await fetch(`https://swapi.dev/api/films/${id}`)).json(),
};
